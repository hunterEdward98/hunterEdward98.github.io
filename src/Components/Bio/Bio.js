...
const Bio = () => {
  return (
    <div classname="d-flex row justify-content-center">
      ...
      was not for me. I attended Emerging Digital Academy, and After completing
      their course, I am confident in my ability to adapt to a rapidly evolving
      field of web-development, and learn the modern day tools that are used,
      developing complex projects to prove my skills.
    </div>
  );
};
export default Bio;
